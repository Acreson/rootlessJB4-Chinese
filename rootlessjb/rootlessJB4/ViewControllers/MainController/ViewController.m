...
- (IBAction)creditButtonAction:(UIButton *)sender {
    NSString *message = [NSString stringWithFormat:@"由bplank开发RootlessJB4\n\n由Lakr233开发Saily Package Manager\n\n由Jake James提供Original rootlessJB & time_waste\n\n 由DaveWijk提供UI设计 \n\n 由Acreson提供完整汉化 \n\n 版本 RC.2.1-Chinese"];
    
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"名单" message:message preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *Done = [UIAlertAction actionWithTitle:@"我晓得了" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action){
...
- (IBAction)optionButtonAction:(UIButton *)sender {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/Acreson/rootlessJB4-Chinese"]];
}
